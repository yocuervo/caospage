                ...
                <div className='games__list_name'>Assassin's Creed</div>
                    <div className='row games__list_container'>
                        ...
                        <div className='col games__list_game'>
                            ...
                            grupo de latinos, en un server europeo donde lográbamos destacarnos y competir a pesar de la 
                            enorme desventaja técnica que teníamos al jugar con 300ms de diferencia. En un principio fuimos 
                            simplemente rivales con muchas cosas en común, luego con el tiempo fuimos de a poco compartiendo 
                            horas y estrechando vínculos, hasta que un día se abrió la posibilidad de formar clanes dentro 
                            del juego. Fué allí cuando surgió la idea de agruparnos bajo un mismo estandarte, romper con el 
                            juego individual y crear nuestro propio clan, en los primeros meses nos llamábamos RIP (Requiescat 
                            in pace, por la célebre frase que los Asesinos pronunciaban a sus víctimas al asesinarlos). Pero al
                            poco tiempo y con la llegada de Assassin’s Creed 4: Black Flag, nos pasamos a llamar CAOS y ese 
                            pequeño grupo inicial de latinos fué creciendo y adoptando miembros de los 5 continentes.<br/>
